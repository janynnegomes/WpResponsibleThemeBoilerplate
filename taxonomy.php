<?php get_header();
    ...
    $tag = get_query_var('taxonomy'); 
    $slug = get_query_var($tag);  
    $nome = get_term_by( 'slug', $slug, $tag);

    $singularNameTaxonomy = get_taxonomy($tag);
    $singularNameTaxonomy = $singularNameTaxonomy->labels->singular_name;
             ...
             <section id="main-content">     
              ...
              <section class="formations">
                    <div class="list">
                        ...
                        <h1><?php echo $singularNameTaxonomy.': '.$nome->name; ?> </h1>                  
                        <ul>                            
